...
import { Search, Globe, Thermometer, CloudRain, Sun, Leaf, Satellite } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8 animate-fade-in">
          <div className="flex items-center justify-center mb-4">
            <Satellite className="w-8 h-8 sm:w-12 sm:h-12 text-white mr-2 sm:mr-3 animate-pulse-slow" />
        ...
        <div className="card animate-slide-up">
          ...
          <p className="text-gray-600 mb-4 sm:mb-6 text-sm sm:text-base">
            Showing {filteredCountries.length} of {countries.length} countries with live NASA data
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4 max-h-[60vh] sm:max-h-96 overflow-y-auto scrollbar-hide">
            {filteredCountries.map((country, index) => (
              ...
              >
                ...
                <p className={`text-xs sm:text-sm mb-3 font-medium ${getClimateColor(country.climate)}`}>
                  {country.climate}
                </p>
                ...
                <div className="space-y-2">
                  <div className="metric-card bg-gray-50 border-l-red-400">
                    ...
                    <span className={`font-bold text-xs sm:text-sm ${getMetricColor('temp', country.temperature)}`}>
                  ...
                  <div className="metric-card bg-gray-50 border-l-blue-400">
                    ...
                    <span className={`font-bold text-xs sm:text-sm ${getMetricColor('rain', country.precipitation)}`}>
                  ...
                  <div className="metric-card bg-gray-50 border-l-yellow-400">
                    ...
                    <span className={`font-bold text-xs sm:text-sm ${getMetricColor('solar', country.solar)}`}>
                      {country.solar} W/m²
                    </span>
                  </div>
                  ...
                  <div className="metric-card bg-gray-50 border-l-green-400">
                    ...
                    <span className={`font-bold text-xs sm:text-sm ${getMetricColor('ndvi', country.ndvi)}`}>
                      {country.ndvi}
                    </span>
                  </div>
                </div>
